...
### Case 5: Employee Appeal

```text
AI Decision: Reject
Employee Action: Request Manual Review
Employee Note: Client-related expense requiring additional context
```

Expected result:

```text
Added to Accounting manual review queue
```
...
![Employee Portal](screenshots/employee_portal.png)

## Reimbursement Result

![Reimbursement Result](screenshots/reimbursement_result.png)

## Accounting Dashboard

![Accounting Dashboard](screenshots/accounting_dashboard.png)
